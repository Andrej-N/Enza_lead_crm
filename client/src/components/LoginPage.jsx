          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-3 py-3 md:py-2.5 border border-gray-600 rounded-lg text-base md:text-sm bg-gray-700 text-gray-100 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent placeholder-gray-500"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 md:py-2.5 bg-emerald-600 text-white rounded-lg text-sm font-medium hover:bg-emerald-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
